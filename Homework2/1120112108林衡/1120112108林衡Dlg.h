...
public:
	...
	CnComm m_CnComm;
	char m_chGPSDataFromReceiver[100]; //存放接收的GPS数据
	...
	CEdit m_ctrlEditLat;
	CEdit m_ctrlEditLon;
	CEdit m_ctrlEditSatNum;
	CEdit m_ctrlEditHDOP;
	CEdit m_ctrlEditUTC;
	CEdit m_ctrlEditAlt;
	CEdit m_ctrlEditSpeed;
	CEdit m_ctrlEditHead;
	CEdit m_ctrlEditRXDATADISP;
	void Proc_GPGGA(char* chBuff, int nNum);
};
